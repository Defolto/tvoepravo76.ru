...
$mail->Body    = 'Новая заявка на консультацию с выездом в назначенное место!<br>' .$name . ' ' .$secondname. ' оставил(а) заявку, его(её) телефон ' .$phone. '<br>Почта этого пользователя: ' .$email. '<br>Его комментарий: ' .$text. '<br>Желаемое место и дата встречи: ' .$place. ', ' .$data. '<br>Перезвоните ему и назначьте время встречи!';
$mail->AltBody = '';
