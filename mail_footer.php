...
$mail->Body    = 'Заявка на просьбу консультации!<br>' .$name . ' ' .$secondname. ' оставил(а) заявку, его(её) телефон ' .$phone. '<br>Почта этого пользователя: ' .$email. '<br>Его комментарий: ' .$text. '<br>Свяжитесь с ним для дальнейшей работы!';
$mail->AltBody = '';
